...
import DataCompiler from '../src/DataCompiler';
...
describe('Lexer/DataCompiler', () => {
  ...
  it('Should parse objects', () => {
    ...
    (() => {
      ...
      const actual = DataCompiler.object(token);
    ...
    (() => {
      ...
      const actual = DataCompiler.object<{
        foo: string;
        bar: number;
  ...
  it('Should parse arrays', () => {
    ...
    (() => {
      ...
      const actual = DataCompiler.array(token);
    ...
    (() => {
      ...
      const actual = DataCompiler.array<[
        number,
        string,
        boolean,
        null,
    ...
    (() => {
      ...
      const actual = DataCompiler.array<{ label: string, value: string }[]>(token);
